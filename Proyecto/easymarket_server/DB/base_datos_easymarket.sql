...
CALL createUser(30930363, "Katherine Mora", 3, "av siempreviva 123", 2, 0, true, "monitoslocos27", "katerine_O.O@gmail.com", 3294568709);
...
-- MODIFY COLUMN estado BIT(1);
-- ALTER TABLE tb_productos
-- MODIFY COLUMN telefono_usuario BIGINT;
